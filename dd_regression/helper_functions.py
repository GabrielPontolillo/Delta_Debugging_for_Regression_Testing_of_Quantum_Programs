...
def files_to_spreadsheet(algorithm_name, chaff_lengths, inputs_per_properties, numbers_of_properties, number_of_measurements,
        ...
        for chaff_length in chaff_lengths:
            for inputs_per_property in inputs_per_properties:
                try:
                    ...
                    output_dict[(chaff_length, inputs_per_property, number_of_properties, "expected to find")] = output[2]
                    output_dict[(chaff_length, inputs_per_property, number_of_properties, "artifacts in output")] = output[4]
                    output_dict[(chaff_length, inputs_per_property, number_of_properties, "artifacts added")] = output[5]
            ...
            for outputs in ["correctly found", "expected to find", "percentage found", "artifacts in output", "artifacts added", "ratio correct/artifact", "time"]:
                ...
                for chaff_length in chaff_lengths:
                    if outputs == "percentage found":
                        correctly_found = output_dict.get((chaff_length, inputs_per_property, number_of_properties, "correctly found"))
                        expected_to_find = output_dict.get((chaff_length, inputs_per_property, number_of_properties, "expected to find"))
                        ...
                        correctly_found = output_dict.get((chaff_length, inputs_per_property, number_of_properties, "correctly found"))
                        artifacts_in_output = output_dict.get((chaff_length, inputs_per_property, number_of_properties, "artifacts in output"))

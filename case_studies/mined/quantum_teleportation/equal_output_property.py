...
from dd_regression.helper_functions import get_quantum_register
...
class EqualOutputProperty(PropertyBasedTestInterface):
    ...
    @staticmethod
    def verification_heuristic(original_failing_circuit, output_distribution, input_state_list, measurements=1000):
        pass

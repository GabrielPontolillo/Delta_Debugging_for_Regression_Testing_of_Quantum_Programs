...
class QuantumTeleportationMined(CaseStudyInterface):
    ...
    def test_function(self, deltas, src_passing, src_failing, inputs_to_generate=25, measurements=1000):
        return TeleportationOracle.test_oracle(src_passing, src_failing, deltas, [EqualOutputProperty, EqualOutputProperty])
